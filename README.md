...
You edit audio like a movie hacker ⚡
...
🎧 Audio lessons (mp3 files included... well, some of them — see below).

🎨 Multiple pages like learn.html, listen.html, create.html, edit Audio.html.

🎛️ Audio tools: trim, reverse, voice-change — your mini audio lab.

📚 Courses redirect to new1.html as intended.
...
├─ learn.html
├─ listen.html
├─ new1.html       ← Opens when 'Courses' is clicked
├─ create.html
├─ edit Audio.html
├─ trim.html
├─ reverse_audio.html
...
git clone https://github.com/Harshbv/MeloLearn.git


Open NOW.html in your browser.

To use advanced audio options, run via a local server (XAMPP/WAMP).
...
More courses, more lessons, and of course… more vibes
